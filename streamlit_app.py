...
plot_sf = sf.plot(width=500, height=500, return_fig=True)
...
if flag_comparison:
    ...
    plot_sf1=sf1.plot(width=500, height=500, plot_is_static=plot_is_static, return_fig=True)
    st.plotly_chart(plot_sf1, use_container_width=True)

    # with col2:
    #     plot_sf2=sf1.plot(width=500, height=500, plot_is_static=plot_is_static, return_fig=True)[0]
    ...
    # storing the plot in a variable
    # exposing the plot via streamlit
    plot_sf=sf2.plot(width=500, height=500, return_fig=True)
    st.plotly_chart(plot_sf, use_container_width=True)
    ...
    # storing the plots in variables
    # exposing the plots via streamlit
    plot_sf1=sf3.plot(width=500, height=500, plot_is_static=plot_is_static, return_fig=True)
    st.plotly_chart(plot_sf1, use_container_width=True)

    # with col2:
    #     plot_sf2=sf3.plot(width=500, height=500, plot_is_static=plot_is_static, return_fig=True)[0]
    #     st.plotly_chart(plot_sf2, use_container_width=True)
    ...
    # storing the plots in variables
    # exposing the plots via streamlit
    plot_sf1=sf4.plot(width=500, height=500, plot_is_static=plot_is_static, return_fig=True)
    st.plotly_chart(plot_sf1, use_container_width=True)

    # with col2:
    #     plot_sf2=sf4.plot(width=500, height=500, plot_is_static=plot_is_static, return_fig=True)[1]
    #     st.plotly_chart(plot_sf2, use_container_width=True)
    ...
    # storing the plot in a variable
    plot_sf = sf6.plot(width=500, height=500, return_fig=True)
    # exposing the plot via streamlit
    st.plotly_chart(plot_sf, use_container_width=True)